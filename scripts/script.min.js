...
!function(){var t=document.getElementsByClassName("js-cd-top")[0],o=!1;function i(){var e=window.scrollY||document.documentElement.scrollTop;405<e?Util.addClass(t,"cd-top--is-visible"):Util.removeClass(t,"cd-top--is-visible cd-top--fade-out"),11600<e&&Util.addClass(t,"cd-top--fade-out"),o=!1}t&&(window.addEventListener("scroll",function(e){o||(o=!0,window.requestAnimationFrame?window.requestAnimationFrame(i):setTimeout(i,250))}),t.addEventListener("click",function(e){e.preventDefault(),window.requestAnimationFrame?Util.scrollTo(0,700):window.scrollTo(0,0)}))}();
...
anime({
  targets: '.page-header__paragraph',
  translateY: -20,
  duration: 700,
  opacity: 1,
  delay: 2700,
...
particlesJS.load('particles-js--htc', 'scripts/particlesjs-config--htc.json');

particlesJS.load('particles-js--psvr', 'scripts/particlesjs-config--psvr.json');

particlesJS.load('particles-js--ps4', 'scripts/particlesjs-config--ps4.json');
...
var showhideTel = document.getElementById('tel');
var patternMaskTel = new IMask(showhideTel, {
...
Pageclip.form(form, {
  ...
  successTemplate: "<span>Спасибо, вопрос успешно отправлен</span><a class='back-home' href='#'>Закрыть</a><button class='form-close'></button>"
});
